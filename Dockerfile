...
# - 60% de heap deja margen para metaspace, hilos, buffers directos y el
#   propio overhead del JVM dentro de los 512MB totales.
...
ENV JAVA_OPTS="-XX:+UseSerialGC -XX:MaxRAMPercentage=60.0 -XX:MaxMetaspaceSize=128m -XX:+ExitOnOutOfMemoryError"
